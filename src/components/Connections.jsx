...
const Connections = () => {
    ...
    if(connections.length === 0) 
        return (
            ...
            <h1 className="m-5 text-2xl bg-base-100 p-3 rounded-box">No Connections</h1>
            </div>
        );
    ...
    return (
        <div className="flex-1 flex flex-col justify-top items-center m-10 bg-base-300 rounded-box">
            ...
            {connections.map((connection) => {
                ...
                return (
                    <div key={_id} className="m-2 p-2 flex justify- w-150  bg-black items-center justify-evenly rounded-box">
                        <div className = "">
